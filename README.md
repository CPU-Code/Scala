...
- [x] [函数参数](functional/src/main/scala/com/cpucode/parameter/Parameter.scala)
...
- [x] [函数作为参数](functional/src/main/scala/com/cpucode/paraFunction/ParaFunction.scala)
...
- [x] [类型检查和转换](toobject/src/main/scala/com/cpucode/extendsTest/ExtendsTest.scala)
...
- [x] [匹配对象及样例类](match/src/main/scala/com/cpucode/matchObject/MatchObject.scala)
